...
?>
   ...
   <tr> 
      ...
      <td width="700"  bgcolor="#F2F2F2">
         ...
         <select name="opt1">
            ...
            <?
      $query1="select * from opt order by name76";
      ...
      $row1=mysqli_fetch_array($result1);
         if($row[opt1]==$row1[no76])
            ...
            echo("<option value='$row1[no76]'>$row1[name76]");
         }
         ?>
   ...
   ?>
      ...
      <td width="700"  bgcolor="#F2F2F2">
         <textarea name="contents" rows="4" cols="70"><?=$row[contents76]?></textarea>
      </td>
   </tr>
   <tr> 
...
?>
   ...
   <tr> 
      ...
      if($row[icon_sale76]==1){
         ...
         echo("할인율 : "); echo("<input type='text' name='discount' value='$row[discount76]' size='3' maxlength='3'> %");
