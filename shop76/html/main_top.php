...
<table width="1180" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td><a href="index.html"><img src="product/blue.png" width="1180" height="200" border="0"></a></td>
	</tr>
</table>
...
<table width="1180" height="35" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr>
		<td width="700" align="left"><font color="#666666"><b>&nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  Welcome ! &nbsp;&nbsp 
		<? 
			if(!$cookie_no)
				echo("고객");
			else
				...
				<tr> 
					<td valign="top"> 
						...
						<table width="177"  border="0" >
							<tr><td height="30" align="center" style="font-size:12pt;color:#333333"><b>Category</b></td></tr>
							<tr>
								<td bgcolor="#FFFFFF">
							...
							<tr>
								<td bgcolor="#FFFFFF">
									<table width="100%"  border="0" cellspacing="0" cellpadding="0">
										<tr><td><a href="qa.php"><img src="product/a.png"   onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td></tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td bgcolor="#FFFFFF">
									<table width="100%"  border="0" cellspacing="0" cellpadding="0">
										<tr><td><a href="faq.php"><img src="product/b.png"   onmouseover="img_change('on')" onmouseout="img_change('off')"></a></td></tr>
									</table>
								</td>
							</tr>
						</table>
