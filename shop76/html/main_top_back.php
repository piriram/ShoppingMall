		...
		<td align="right" valign="bottom">
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<!--
						not cookie_no
						member_login.php top_menu02.gif
						member_agree.php top_menu03.gif
						else
						member_logout.php top_menu02_1.gif
						member_edit.html top_menu03_1.gif
					...
					<?
						...
						{ 
							...
							<td><img src="images/top_menu_line.gif" width="11"></td>
							<td><a href="member_edit.html"><img src="images/top_menu03_1.gif" border="0"></a></td>
...
<table width="959" height="25" border="0" cellspacing="0" cellpadding="0" align="center">
	...
	<tr bgcolor="#F0F0F0">
		<td width="181" align="center"><font color="#666666">&nbsp <b>Welcome ! &nbsp;&nbsp고객님 
