            ...
            echo("<tr>");
               ...
               echo("<td width='200' height='225' align='center' valign='top'>
                  <table border='0' cellpadding='0' cellspacing='0' width='100' class='cmfont'>
                     <tr> 
                        <td align='center'> 
                           <a href='product_detail.php?no=$row[no76]'><img src='product/$row[image1]' width='180' height='200' border='0'></a>
                        </td>
                     </tr>
                     <tr><td height='5'></td></tr>
                     <tr> 
                        <td height='20' align='center'>
                           <a href='product_detail.php?no=$row[no76]'><font color='444444'>$row[name76]</font></a>&nbsp;");
                           ...
                           if($row[icon_sale76] == 1)
                                 {
                                  ...
                                  echo("<img src='images/i_sale.gif' align='absmiddle' vspace='1'><b>$row[discount76]%</b> ");
                                 }
